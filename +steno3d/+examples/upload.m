...
%
%   Example 1: <a href="matlab: help steno3d.login
%   ">Log in</a>, implictly convert a figure, and <a href="matlab:
%   help steno3d.upload">upload</a> as private
...
%       steno3d.logout();
%
%   Example 2: Log in without saving credentials, upload a <a href="matlab:
