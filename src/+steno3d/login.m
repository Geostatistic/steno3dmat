...
%
%       %%%bold[CredentialsFile]: string (default: '~/.steno3d_client/credentials')
...
%           login.
%       %%%bold[SkipCredentials]: true or false (default: false)
...
%           compromised you may delete it throuh your online %%%link[profile](https://steno3d.com/settings/developer).
%
...
%
%   %%%link[https://steno3d.com/signup](https://steno3d.com/signup)
%
%   Then, you can request a devel key:
%
%   %%%link[https://steno3d.com/settings/developer](https://steno3d.com/settings/developer)
%
