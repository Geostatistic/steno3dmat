...
%   Volumes are 3D resources. Their geometry is defined by a %%%ref[Mesh3DGrid](steno3d.core.Mesh3DGrid)
%   with regularly spaced x-, y-, and z-axes. Volumes may have %%%ref[Data](steno3d.core.DataArray) defined
%   on the cell-centers. There are several %%%ref[volume options](steno3d.core.opts.VolumeOptions) and
%   %%%ref[mesh options](steno3d.core.opts.Mesh3DOptions) available for customizing the appearance.
%
%   `Volume` resources can also be created through a high-level functional
%   interface with %%%ref[steno3d.volume](steno3d.volume).
%
%   %%%properties
%
