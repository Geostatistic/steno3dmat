...
%   %%%runexamples
%
%   %%%seealso steno3d.addData, steno3d.scatter, steno3d.trisurf, steno3d.surface
%
...
%%%image /images/addData-examples-images/addData-example-1.png
...
%%%image /images/addData-examples-images/addData-example-2.png
...
%%%image /images/addData-examples-images/addData-example-3.png
