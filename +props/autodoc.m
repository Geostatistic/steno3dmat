...
%   with '%   See also' (note the spacing must be exact). Everything below
...
%       %   THIS TOO.
%       %
%       %   See also props.HasProps, this line is saved
...
%
    ...
    while ~isempty(commentline) && strcmp(commentline(1), '%')
        if length(commentline) > 11 &&                                  ...
                strcmp(commentline(1:12), '%   See also')
    ...
    fprintf(tempfid, ['%%   ' upper(nmsplit{end}) ' implements '        ...
            '<a href="matlab: help props.HasProps">HasProps</a> for '   ...
            'dynamic, type-checked <a href="matlab: help props.Prop">'  ...
            'properties</a>\n%%\n']); 
